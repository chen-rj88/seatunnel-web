...
-- seatunnel_web.t_seatunnel_streaming_job_metrics_current definition

CREATE TABLE `t_seatunnel_streaming_job_metrics_current`
(
    ...
    `client_id`               bigint                  DEFAULT NULL COMMENT 'SeaTunnel Client ID',
    `job_status`              varchar(32)             DEFAULT NULL COMMENT 'Engine 返回任务状态',
    `read_row_count`          bigint         NOT NULL DEFAULT '0',
    `write_row_count`         bigint         NOT NULL DEFAULT '0',
    `read_qps`                decimal(20, 4) NOT NULL DEFAULT '0.0000',
    `write_qps`               decimal(20, 4) NOT NULL DEFAULT '0.0000',
    `read_bytes`              bigint         NOT NULL DEFAULT '0',
    `write_bytes`             bigint         NOT NULL DEFAULT '0',
    `read_bps`                decimal(20, 4) NOT NULL DEFAULT '0.0000',
    `write_bps`               decimal(20, 4) NOT NULL DEFAULT '0.0000',
    ...
    `last_collect_time_ms`    bigint         NOT NULL COMMENT '最近采集时间戳，毫秒',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='SeaTunnel streaming latest metrics summary';

CREATE TABLE `t_seatunnel_streaming_job_metrics_snapshot`
(
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='SeaTunnel streaming pipeline metrics snapshot';

CREATE TABLE `t_seatunnel_streaming_job_table_metrics_current`
(
    `job_instance_id`      bigint         NOT NULL,
    `job_definition_id`    bigint         NOT NULL,
    `engine_job_id`        bigint                  DEFAULT NULL,
    `client_id`            bigint                  DEFAULT NULL,
    `pipeline_id`          int            NOT NULL DEFAULT '0',
    `source_table`         varchar(512)            DEFAULT NULL,
    `sink_table`           varchar(512)            DEFAULT NULL,
    ...
    `error_msg`            text,
    `last_collect_time_ms` bigint         NOT NULL,
    `last_collect_time`    datetime       NOT NULL,
    `create_time`          datetime       NOT NULL DEFAULT CURRENT_TIMESTAMP,
    `update_time`          datetime       NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
